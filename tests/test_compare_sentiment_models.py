...
class CompareSentimentModelsTests(unittest.TestCase):
        ...
        rows = [
            {
                ...
                "climatebert_sentiment_score": 0.7,
            ...
            },
            {
                ...
                "sentiment_score": -0.8,
                "climatebert_sentiment": "positive",
                "climatebert_sentiment_score": 0.4,
            ...
            },
            {
                ...
                "sentiment_score": -0.3,
                "climatebert_sentiment": "negative",
                "climatebert_sentiment_score": -0.2,
            ...
            },
            {
                ...
                "sentiment": "positive",
                "sentiment_score": 0.6,
                "climatebert_sentiment": "neutral",
                "climatebert_sentiment_score": 0.0,
            ...
            },
            {
                ...
                "climatebert_sentiment": "positive",
                "climatebert_sentiment_score": 0.99,
                "created_date": "2024-01-05",
                "subreddit": "energy",
    ...
    def test_load_comparison_df_filters_comments_and_adds_fields(self):
        df = load_comparison_df(self.input_csv, posts_only=True, run_climatebert=False)
    ...
    def test_disagreement_table_prefers_label_disagreements(self):
        ...
        self.assertTrue((table["sentiment"] != table["climatebert_sentiment"]).all())
    ...
    def test_generate_comparison_artifacts_creates_expected_outputs(self):
        ...
        required_paths = [
            ...
            summary["top_2_climatebert_positive_csv"],
            summary["top_2_climatebert_negative_csv"],
        ]
